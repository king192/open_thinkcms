...
CREATE TABLE `app_credit` (
  ...
  PRIMARY KEY (`id`),
  KEY `uid` (`uid`)
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8 COMMENT='积分表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `app_credit` VALUES (1,5,1,20160418,11),(2,5,1,20160418,11),(3,5,1,20160423,3),(4,1,1,20160423,2),(5,1,2,20160424,10),(6,1,2,20160425,6),(7,1,1,20160425,2),(8,4,2,20160425,8),(9,4,1,20160425,2),(10,4,1,20160426,2),(11,1,1,20160426,2),(12,1,2,20160426,2);
...
INSERT INTO `app_sign` VALUES (1,1,1461669023,3),(2,2,1450888360,1),(3,3,1460194676,2),(4,4,1461665307,2),(15,5,1460991124,1);
...
-- Dump completed on 2016-04-26 21:35:07
