...
CREATE TABLE `app_admin_belong_group` (
  ...
  PRIMARY KEY (`id`),
  KEY `uid` (`uid`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='用户所在管理组';
...
INSERT INTO `app_admin_belong_group` VALUES (9,20,13),(14,19,13),(17,22,13),(18,1,13),(19,1,15),(20,25,16);
...
CREATE TABLE `app_admin_group` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='管理组';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `app_admin_group` VALUES (13,'开发者','程序猿',1,1461208680),(16,'游客','游客',1,1461751157);
...
CREATE TABLE `app_admin_member` (
  ...
  PRIMARY KEY (`id`),
  KEY `uid` (`uid`)
) ENGINE=InnoDB AUTO_INCREMENT=23 DEFAULT CHARSET=utf8 COMMENT='管理员';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `app_admin_member` VALUES (8,13,0,0,0),(9,14,1461250684,0,0),(14,19,1461251640,0,0),(15,20,1461251729,0,0),(16,21,1461291990,0,0),(20,22,1461319776,0,0),(21,1,0,0,0),(22,25,1461751382,0,0);
...
CREATE TABLE `app_auth` (
  ...
  KEY `action` (`action`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8 COMMENT='权限规则列表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `app_auth` VALUES (1,0,'Adminn','UserController','get_list','','用户管理',0),(4,1,'Adminn','Test','hi','','普通用户',0),(5,1,'Adminn','f','f1','','后台用户',0),(10,0,'Adminn','Secret','index','','私密档案',0),(11,0,'Adminn','t','t','','规则管理',0),(12,11,'Adminn','Auth','add_auth_post','','添加规则',0),(13,11,'Adminn','Auth','edit_post','','编辑规则',0),(14,11,'Adminn','Auth','del_post','','删除规则',0),(15,0,'Adminn','f','f','','菜单管理',0),(16,15,'Adminn','Menu','add_post','','添加菜单',0),(17,15,'Adminn','Menu','del_post','','删除菜单',0),(18,15,'Adminn','Menu','edit_post','','编辑菜单',0),(19,5,'Adminn','f','f2','','管理员',0),(20,5,'Adminn','f','f3','','管理组',0),(21,19,'Adminn','AdminUser','get_user_list','','添加管理员',0),(22,19,'Adminn','AdminUser','admin_post','','编辑管理员',0),(23,20,'Adminn','AdminGroup','add_group_post','','编辑管理组',0),(24,20,'Adminn','AdminGroup','get_group_list','','添加管理组',0),(25,20,'Adminn','AdminGroup','del_group','','删除管理组',0),(26,4,'Adminn','UserList','get_list','','编辑用户',0);
...
CREATE TABLE `app_comments` (
  ...
  KEY `to_uid` (`to_uid`),
  KEY `is_read` (`is_read`)
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=utf8 COMMENT='文章帖子评论';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `app_comments` VALUES (1,1,0,1461496503,'jhgjhblbbkblkjlk',0,0,0,0,0,0),(2,1,7,1461497183,'hello world！！！！！！！！！！！',0,0,0,0,0,0),(3,1,7,1461497372,'么么大，哈哈哈',0,0,0,0,0,0),(4,1,7,1461507681,'you are so great!',0,0,0,0,0,0),(5,1,7,1461507717,'love you !!!!!',0,0,0,0,0,0),(6,1,7,1461510556,'you are so cool!!!!!!!!!!!!!!!!!!!!!!!!',0,0,0,0,0,0),(7,1,7,1461510966,'how do you do !',0,0,0,0,0,0),(8,1,7,1461511165,'how do you do !!',0,0,0,1,0,0),(9,1,7,1461513236,'I am fine! think you',0,7,0,0,0,0),(10,1,7,1461514069,'welllllllllllllll',0,8,0,1,0,0),(11,1,7,1461515849,'listen to me , you are so good!',0,8,0,0,0,0),(12,1,7,1461517161,'okkkkkkkkkkk',0,10,0,0,0,0),(13,1,6,1461523874,'不错，markdown',0,0,0,0,0,0),(14,1,10,1461556086,'窗前明月光，疑是地上霜',0,0,0,0,0,0),(15,1,10,1461556104,'窗前明月光，疑是地上霜!',0,0,0,0,0,0),(16,1,10,1461556696,'举头望明也，低头思故乡',0,0,0,0,0,0),(17,1,10,1461556880,'锄禾日当午，汗滴禾下土',0,0,0,0,0,0),(18,1,10,1461557236,'千山鸟飞绝，万径人踪灭',0,0,0,0,0,0),(19,1,10,1461557477,'孤舟蓑笠翁，独钓寒江雪',0,0,0,0,0,0),(20,1,10,1461557602,'一去二三里，延村四五家',0,0,0,0,0,0),(21,1,10,1461557791,'停车坐爱枫林晚，霜叶红于二月花',0,0,0,0,0,0),(22,1,10,1461557996,'停车坐爱枫林晚，霜叶红于二月花',0,0,0,1,0,0),(23,1,10,1461558083,'好诗好诗，不错',0,22,0,0,0,0),(24,1,10,1461558488,';lsdjf\'a;sfjldfjsldjfalsfj;alsjfawejfiwf',0,0,0,0,0,0),(25,1,10,1461558698,'野火烧不尽，春风吹又生',0,0,0,1,0,0),(26,1,10,1461558734,'一枝红杏出墙来',0,25,0,0,0,0),(27,1,10,1461559246,'一岁一枯荣,',0,0,0,0,0,0),(28,1,10,1461559447,'春风得意看风景双龙夺凤',0,0,0,1,0,0),(29,1,10,1461559552,'风萧萧兮，雨潺潺兮',0,0,0,0,0,0),(30,1,10,1461559618,'中国文化，博大精深',0,28,0,0,0,0),(31,1,10,1461559669,'丽丽原上草，，',0,0,0,1,0,0),(32,1,10,1461559711,'一岁一枯荣，，，，',0,31,0,0,0,0),(33,1,10,1461559909,'野火烧不尽fff',0,31,0,1,0,0),(34,1,10,1461560285,'红尘滚滚，灰飞烟灭',0,31,0,0,0,0),(35,1,10,1461560591,'good good study day day up!',0,31,0,1,0,0),(36,1,10,1461560625,'好好学习，天天向上',0,35,0,0,0,0),(37,1,10,1461560667,'艾玛，副教授打飞机阿联的发',0,0,0,1,0,0),(38,1,10,1461561926,'号人一生平安',0,35,0,0,0,0),(39,1,10,1461567056,'野火烧不尽，快递费加拉斯地方了',0,31,0,0,0,0),(40,4,10,1461591573,'大家好~~~~~~~',0,0,0,1,0,0),(41,4,10,1461591606,'how are you!',0,37,0,0,0,0),(42,4,10,1461594520,'春风吹又生！',0,33,0,0,0,0),(43,4,10,1461599248,'你是管理员！！！',0,40,0,0,4,0),(44,4,10,1461599571,'呢吗呢吗好，',0,31,0,0,1,1),(45,24,12,1461694036,'       ',0,0,0,0,0,0),(46,24,12,1461694091,'&lt;script&gt;alert(true);&lt;/script&gt;',0,0,0,0,0,0),(47,1,15,1461726161,'how are you!!',0,0,0,1,0,0),(48,1,15,1461726227,'键盘快捷键!!!',0,0,0,1,0,0),(49,1,15,1461726244,'okkkkkkkkkkkk',0,48,0,0,1,1),(50,1,15,1461727495,'I am fine!!!!',0,47,0,0,1,1);
...
CREATE TABLE `app_credit` (
  ...
  PRIMARY KEY (`id`),
  KEY `uid` (`uid`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='积分表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `app_credit` VALUES (1,5,1,20160418,11),(2,5,1,20160418,11),(3,5,1,20160423,3),(4,1,1,20160423,2),(5,1,2,20160424,10),(6,1,2,20160425,6),(7,1,1,20160425,2),(8,4,2,20160425,8),(9,4,1,20160425,2),(10,4,1,20160426,2),(11,1,1,20160426,2),(12,1,2,20160426,2),(13,24,1,20160427,2),(14,1,1,20160427,4);
...
CREATE TABLE `app_feedback` (
  ...
  PRIMARY KEY (`id`),
  KEY `is_read` (`is_read`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COMMENT='用户建议或bug反馈表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `app_feedback` VALUES (1,4,1461661088,0,'你好','\r\n\r\n不错哦',0),(2,4,1461661131,0,'     ','\r\n\r\n不错哦',0),(3,4,1461661174,0,'hello','不错哦',0),(4,4,1461661886,0,'123','`dkflsdfjlsdfa',0);
...
CREATE TABLE `app_menu` (
  ...
  KEY `status` (`status`),
  KEY `parentid` (`parentid`)
) ENGINE=InnoDB AUTO_INCREMENT=119 DEFAULT CHARSET=utf8 COMMENT='后台菜单';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `app_menu` VALUES (100,0,'Adminn','UserController','index','',1,'用户管理',0,'','test',0),(107,100,'Adminn','1','1','1',1,'后台用户',1,'','',0),(108,107,'Adminn','AdminUser','get_user_list','',1,'管理员',1,'','',0),(109,107,'Adminn','AdminGroup','get_group_list','',1,'管理组',1,'','',0),(111,100,'f','f','f2','',1,'前台用户',1,'','',0),(112,111,'Adminn','UserList','get_user_list','',1,'用户列表',1,'','',0),(115,0,'Adminn','Secret','index','',1,'私密档案',1,'','',0),(116,0,'Adminn','AdminUser','myself','',1,'我的资料',1,'','',0),(117,0,'Adminn','Content','index','',1,'内容管理',1,'','',0),(118,117,'Adminn','Content','get_posts','',1,'文章管理',1,'','',0);
...
CREATE TABLE `app_posts` (
  ...
  KEY `cate` (`cate`),
  KEY `istop` (`istop`)
) ENGINE=InnoDB AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='文章帖子';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `app_sign` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='用户签到表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `app_sign` VALUES (1,1,1461695050,4),(2,2,1450888360,1),(3,3,1460194676,2),(4,4,1461665307,2),(15,5,1460991124,1),(16,24,1461694595,1);
...
INSERT INTO `app_user` VALUES (1,'admin123','87d9bb400c0634691f0e3baaf1e2fd0d',1450523317,1461753376,1461745273,0,0,'1434970057@qq.com','12345678901',1,NULL,0,'','127.0.0.1','Uploads/avatar/2016/04/2720160427151933321.jpeg',28,19,0,'http://yunshare.net','1992-12-01',''),(2,'admin1','87d9bb400c0634691f0e3baaf1e2fd0d',1450586825,1451110812,1460143108,0,0,'1293812979@qq.com','0',1,NULL,0,'','127.0.0.1','http://saetp.qq/Uploads/avatar/2015/12/26/20151226164023966.jpeg',0,0,0,